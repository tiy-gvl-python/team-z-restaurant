...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('orders', '0009_auto_20150711_1820'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='menuitem',
            name='menu_parts',
            field=models.CharField(default='App', choices=[('Appetizer', 'Appetizer'), ('Entree', 'Entree'), ('Desert', 'Desert'), ('Drink', 'Drink')], max_length=20, blank=True),
        ),
    ]
